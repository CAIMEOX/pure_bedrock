...
export const getState = a => b => a.getState(b)
export const getTags_BlockPermutation = a => a.getTags()
export const hasTag_BlockPermutation = a => b => a.hasTag(b)
export const matches = a => b => c => a.matches(b,c)
export const resolve = a => b => M.BlockPermutation.resolve(a,b)
...
export const getRawText = a => b => a.getRawText(b)
export const getText = a => b => a.getText(b)
export const getTextDyeColor = a => b => a.getTextDyeColor(b)
export const setText = a => b => c => a.setText(b,c)
export const setTextDyeColor = a => b => c => a.setTextDyeColor(b,c)
...
export const getIntersection = a => b => M.BoundingBoxUtils.getIntersection(a,b)
...
export const fade = a => b => a.fade(b)
export const setCamera = a => b => c => a.setCamera(b,c)
...
export const mk_CompoundBlockVolume = a => new M.CompoundBlockVolume(a)
...
export const peekLastVolume = a => b => a.peekLastVolume(b)
...
export const setOrigin = a => b => c => a.setOrigin(b,c)
export const translateOrigin = a => b => c => a.translateOrigin(b,c)
...
export const createExplosion = a => b => c => d => a.createExplosion(b,c,d)
export const fillBlocks = a => b => c => d => e => a.fillBlocks(b,c,d,e)
export const getBlock = a => b => a.getBlock(b)
export const getBlockFromRay = a => b => c => d => a.getBlockFromRay(b,c,d)
export const getEntities = a => b => a.getEntities(b)
export const getEntitiesAtBlockLocation = a => b => a.getEntitiesAtBlockLocation(b)
export const getEntitiesFromRay = a => b => c => d => a.getEntitiesFromRay(b,c,d)
...
export const setWeather = a => b => a.setWeather(b)
export const spawnEntity = a => b => c => a.spawnEntity(b,c)
export const spawnItem = a => b => c => a.spawnItem(b,c)
export const spawnParticle = a => b => c => d => a.spawnParticle(b,c,d)
...
export const defineBoolean = a => b => c => a.defineBoolean(b,c)
export const defineNumber = a => b => c => a.defineNumber(b,c)
export const defineString = a => b => c => d => a.defineString(b,c,d)
export const defineVector = a => b => c => a.defineVector(b,c)
...
export const getEnchantment = a => b => a.getEnchantment(b)
...
export const getEquipment = a => b => a.getEquipment(b)
export const getEquipmentSlot = a => b => a.getEquipmentSlot(b)
export const setEquipment = a => b => c => a.setEquipment(b,c)
...
export const getSpawnPoint = a => a.getSpawnPoint()
...
export const setSpawnPoint = a => b => a.setSpawnPoint(b)
...
export const clearObjectiveAtDisplaySlot = a => b => a.clearObjectiveAtDisplaySlot(b)
export const getObjective = a => b => a.getObjective(b)
export const getObjectiveAtDisplaySlot = a => b => a.getObjectiveAtDisplaySlot(b)
...
export const setObjectiveAtDisplaySlot = a => b => c => a.setObjectiveAtDisplaySlot(b,c)
...
export const getScore = a => b => a.getScore(b)
...
export const setTitle = a => b => c => a.setTitle(b,c)
...
export const runInterval = a => b => c => a.runInterval(b,c)
export const runTimeout = a => b => c => a.runTimeout(b,c)
...
export const playMusic = a => b => c => a.playMusic(b,c)
export const playSound_World = a => b => c => d => a.playSound(b,c,d)
export const queueMusic = a => b => c => a.queueMusic(b,c)
